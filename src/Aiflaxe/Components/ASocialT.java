...
public class ASocialT extends JButton {
    ...
    protected void paintComponent(Graphics graphics) {
        try {
            ...
            button = button.getSubimage(0, 0, 28, 28);
            buttonMove = buttonMove.getSubimage(0, 31, 28, 28);
            buttonPress = buttonPress.getSubimage(0, 62, 28, 28);
