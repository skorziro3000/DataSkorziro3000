...
public class AButtonExit extends JButton {
    ...
    protected void paintComponent(Graphics graphics) {
        try {
            ...
            button = buttonMove = buttonPress = ImageIO.read(AButtonExit.class.getResource("/Aiflaxe/Images/buttons_window.png"));

            button = button.getSubimage(63, 0, 27, 28);
            buttonMove = buttonMove.getSubimage(63, 30, 27, 28);
            buttonPress = buttonPress.getSubimage(63, 60, 27, 28);
